...
<form enctype="multipart/form-data" method="post" class="form-horizontal" action="/CMS/Article/add">
{{ csrf_field() }}
 ...
 <div class="form-group">
    ...
    <div class="col-sm-10">
      <input name="date" value="{{old('date')}}" type="text" class="form-control date-picker" id="date" placeholder="Date">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <textarea rows="10" name="details" class="form-control summernote" id="details" placeholder="Details">{{old('details')}}</textarea>
